...
import org.reactome.server.tools.document.exporter.config.ReactomeNeo4jConfig;
import org.reactome.server.tools.document.exporter.util.ProgressBar;
...
public class Main {
	...
	public static void main(String[] args) throws JSAPException {
		...
		final DocumentExporter exporter = new DocumentExporter(diagrams, ehlds, analysis, null, summary, ds, dos, gs, ados, ps);
